...
class CourseViewState extends State<CourseView> {
  ...
  void recalculateOverallGrade(Course course) {
    List<Assignment>? assignments = course.marks?.marks?[0].assignments?.assignments;
    List<AssignmentGradeCalc>? weights = course.marks?.marks?[0].gradeCalculationSummary?.assignmentGradeCalcs;
    ...
    for (int i = 0; i < (weights?.length ?? 0); i++) {
      ...
      double weightPercent = double.parse(weights?[i].weight?.substring(0, (weights[i].weight?.length ?? 1) - 1) ?? "0.0");
    ...
    for (int i = 0; i < (assignments?.length ?? 0); i++) {
      ...
      pointsTable[assignments?[i].type ?? "undefined"] = pointsTable[assignments?[i].type ?? "undefined"] ?? 0 + pointsEarned;
    }
      ...
      body: ListView (
        children: <Widget> [
          ...
          TextButton(
              onPressed: () => {
                setState(() {
                  widget.courseData.marks?.marks?[0].assignments?.assignments?.insert(0, Assignment(measure: "New Assignment", points: "0.00 / 0.00"));
                })
              },
                    ...
                    Flexible(
                      ...
                      child:
                        TextField(controller: (() {
                          widget.courseData.marks?.marks?[0].assignments?.assignments?[i].nameController.text = widget.courseData.marks?.marks?[0].assignments?.assignments?[i].measure ?? "undefined";
                          return widget.courseData.marks?.marks?[0].assignments?.assignments?[i].nameController;
                        })(), decoration: null,),
                    ),
                      Flexible(
                        child: Row(
                          ...
                          Flexible(child:
                            TextField(
                              controller: (() {
                                widget.courseData.marks?.marks?[0].assignments?.assignments?[i].pointsEarnedController.text = widget.courseData.marks?.marks?[0].assignments?.assignments?[i].pointsEarned.toString() ?? "undefined";
                                return widget.courseData.marks?.marks?[0].assignments?.assignments?[i].pointsEarnedController;
                              })(),
                              decoration: null,
                              ...
                              onChanged: (text) {
                                widget.courseData.marks?.marks?[0].assignments?.assignments?[i].pointsEarned = double.parse((widget.courseData.marks?.marks?[0].assignments?.assignments?[i].pointsEarnedController.text) ?? "0.0");
                          ...
                          Flexible(child:
                            TextField(controller: (() {
                              widget.courseData.marks?.marks?[0].assignments?.assignments?[i].pointsPossibleController.text = widget.courseData.marks?.marks?[0].assignments?.assignments?[i].pointsPossible.toString() ?? "undefined";
                              return widget.courseData.marks?.marks?[0].assignments?.assignments?[i].pointsPossibleController;
                            })(),
                              decoration: null,
                              style: const TextStyle(
                                  fontSize: 15
